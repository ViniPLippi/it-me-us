...
$uri = $URL_PROVIDER . '/authorize?response_type=code' . '&client_id=' . $CLIENT_ID . '&scope=' . $SCOPE . '&redirect_uri=' . urlencode($REDIRECT_URI) . '&nonce=' . getRandomHex() . '&state=' . getRandomHex();
...
if (isset($CODE)) {
    ...
    curl_setopt($ch_token, CURLOPT_POST, count($campos));
    curl_setopt($ch_token, CURLOPT_POSTFIELDS, $fields_string);
    curl_setopt($ch_token, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch_token, CURLOPT_SSL_VERIFYPEER, true);
    $headers = ['Content-Type:application/x-www-form-urlencoded', 'Authorization: Basic ' . base64_encode($CLIENT_ID . ':' . $SECRET)];
    ...
    if ($json_output_confiabilidade['nivel'] == '11') {
        ...
        $headers = ['Accept: application/json', 'Authorization: Bearer ' . $json_output_tokens['access_token']];
        ...
        $headers = ['Accept: application/json', 'Authorization: ' . $json_output_tokens['access_token']];
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do code retornado pelo passo 1, chame o serviço para recuperar os tokens disponívels para
                    sua aplicação
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do access token, podemos extrair algumas informações acerca do usuário. Aproveitamos também
                    para checar a assinatura e tempo de expiração do token:</p>
            </div>
        </div>
        <div class="right_side">
            <?php
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do id token, podemos extrair algumas informações acerca do usuário. Aproveitamos também para
                    checar a assinatura e tempo de expiração do token:</p>
            </div>
        </div>
        <div class="right_side">
            <?php
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do id token, a aplicação pode obter as informações do usuário a partir das informações do
                    próprio id token:</p>
            </div>
        </div>
        <div class="right_side">
            ...
            <div class="result" style="width:900px;">
                ...
                <pre>Telefone Validado: <?php echo $json_output_payload_id_token['phone_number_verified']; ?></pre>
                <!-- (Confirma se o telefone foi validado no cadastro do Gov.br. Poderá ter o valor "true" ou "false")-->
                <pre>Telefone: <?php echo $json_output_payload_id_token['phone_number']; ?></pre>
                ...
                <pre>Email Validado: <?php echo $json_output_payload_id_token['email_verified']; ?></pre>
                <!-- (Confirma se o email foi validado no cadastro do Gov.br. Poderá ter o valor "true" ou "false")-->
                <pre>Email: <?php echo $json_output_payload_id_token['email']; ?></pre>
                ...
                <pre>AMR: <?php echo $json_output_payload_id_token['amr']; ?></pre>
                <!--  Fator de autenticação do usuário. Pode ser “passwd” se o mesmo logou fornecendo a senha, ou “x509” se o mesmo utilizou certificado digital ou certificado em nuvem. -->
                <pre>CNPJ: <?php echo $json_output_payload_id_token['cnpj']; ?></pre>
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do access token, a aplicação pode chamar o serviço para saber quais selos o usuário logado
                    possui:</p>
            </div>
        </div>
        <div class="right_side">
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do access token, a aplicação pode chamar o serviço para saber quais empresas se encontram
                    vinculadas ao usuário logado:</p>
            </div>
        </div>
        <div class="right_side">
            <h3>Json:</h3>
    ...
    <div class="row">
        <div class="left_side">
            <div>
                ...
                <p>De posse do access token, a aplicação pode chamar o serviço para obter dados de uma empresa
                    específica e o papel do usuário logado nesta empresa:</p>
            </div>
        </div>
        <div class="right_side">
            <h3>Json:</h3>
